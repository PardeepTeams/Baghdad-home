...
public class GridAdapterDetailAds  extends RecyclerView.Adapter<GridAdapterDetailAds.ViewHolder> {
    ...
    private AdapterDetailAds.openDetailPage detailPage;
    public ArrayList<Result> propertiesList =new ArrayList<>();

    public GridAdapterDetailAds(Context context, AdapterDetailAds.openDetailPage detailPage, ArrayList<Result> propertiesList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.layout_detail_ads_grid, parent, false);
        ...
        if(propertiesList.get(position).getThumbnail()!=null){
            ...
            if(image!=null && !image.equals("false")){
                ...
                Glide.with(context).load(R.drawable.img_placeholder).placeholder(R.drawable.img_placeholder).
                        apply(new RequestOptions().override(300, 300).diskCacheStrategy(DiskCacheStrategy.ALL)).into(holder.imv_property);
            }
        }
